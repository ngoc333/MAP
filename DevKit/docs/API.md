...
`Navigator`, `DbClient`, `ClientContext`, and `MenuService` are available from `BasePage`; other platform or UI services can be injected when needed. Prefer the helpers above for normal module code.
